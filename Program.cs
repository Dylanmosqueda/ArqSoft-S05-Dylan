...
using Microsoft.AspNetCore.Authentication.Cookies; // ── 1. AGREGADO PARA COOKIES ──
...
// ── 4. AGREGADO: Configurar Autenticación por Cookies ─────────────────────────
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        // Ruta del controlador/acción encargada de mostrar el login cuando el usuario no ha iniciado sesión
        options.LoginPath = "/Account/Login";
    });

// ◄ AGREGA ESTO SI LOS ROLES NO SE DETECTAN AUTOMÁTICAMENTE
...
// ── 5. AGREGADO: Habilitar middleware de autenticación ────────────────────────
// IMPORTANTE: Debe colocarse exactamente entre UseRouting() y UseAuthorization()
